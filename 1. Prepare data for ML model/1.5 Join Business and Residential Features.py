...
# MAGIC ### Section 1.5 Join Business and Residential Features
# MAGIC 
# MAGIC ![](/files/images/plan6.png)
...
business_features_raw = spark.sql("select * from workshop.starbucks_features_business")
nrow_business = business_features_raw.count()

#load residential features
residential_features_raw = spark.sql("select * from workshop.starbucks_features_residential")
...
#spark.sql("DROP TABLE IF EXISTS workshop.starbucks_features")
#starbucks_features.write.format("delta").saveAsTable("workshop.starbucks_features")

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from workshop.starbucks_features

# COMMAND ----------

# MAGIC %sql
# MAGIC select count(*) from workshop.starbucks_features
